...
# =============================================================================
# Governance mode templates (for LLAMOSC comparison)
# =============================================================================
...
DICTATOR_ASSIGNMENT_PREMISE = (
    ...
    "maximize coverage and leverage each person's strengths. Contributors "
    "may accept, negotiate, or refuse their assignment."
)

DICTATOR_CALL_TO_ACTION = (
    "The Project Lead has assigned {name} to: {assigned_task}. "
    "Does {name} accept this assignment, negotiate for a different "
    "task, or refuse?"
)

MERITOCRATIC_PREMISE = (
    "Task assignments this sprint are based on past performance. "
    "Contributors with the best track record on a task type get "
    "priority access to those tasks. {name}'s performance rank: "
    "{rank_info}. Available tasks for {name}: {available_tasks}."
)

MERITOCRATIC_CALL_TO_ACTION = (
    "Based on merit-based priority, which task does {name} choose? "
    "Higher-ranked contributors on each task type get first pick."
)
